...
export function get<T>(params: IGetParameters) {
  let headers = {};
  if (params.query.isAddMapKey) {
    headers = { ...headers, 'X-NCP-APIGW-API-KEY-ID': nmapKeyId, 'X-NCP-APIGW-API-KEY': nmapKey };
  }
...
export const loadReverseGeocode = (params: IReverceGeocodeParams) => {
...
interface IReverceGeocodeParams {
